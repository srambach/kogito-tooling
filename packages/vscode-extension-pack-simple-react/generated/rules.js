var rules_Module_Factory = function () {
  var rules = {
    name: 'rules',
    typeInfos: [{
...
if (typeof define === 'function' && define.amd) {
  define([], rules_Module_Factory);
}
else {
  var rules_Module = rules_Module_Factory();
  if (typeof module !== 'undefined' && module.exports) {
    module.exports.rules = rules_Module.rules;
  }
  else {
    var rules = rules_Module.rules;
  }
}